...
def checkRoundEnd(id,playerdict):
    inactive_check = True
...
async def main():
    ...
    #await ui.println("Successfully exited validation loop!")
    ...
    while game:
        ...
        # Check if player busted then see if they have a second chance to stay in the round
